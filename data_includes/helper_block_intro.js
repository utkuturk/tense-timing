...
var decisionReadyTrial = (blockName, options = {}) =>
  newTrial(
    ...
    newText(
      ...
      "<p>Instruction framing: <b>The &lt;Character&gt;'s &lt;action&gt; is in the past.</b></p>" +
      "<p>For each picture, say a canonical past-tense sentence.</p>" +
      "<p><b>Examples:</b> The Pirate <b>spun</b> a top. / The Pirate <b>dragged</b> a sack.</p>" +
