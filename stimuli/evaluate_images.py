...
OUTPUT_FILE = "stimuli/image_evaluations.json"
...
These images are independently reviewed by a second rater who catches subtle issues.
Be at least as rigorous. Don't let obvious flaws slip by.
