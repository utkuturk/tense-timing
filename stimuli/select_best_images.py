...
# Default files
GEMINI_FILE = "stimuli/image_evaluations.json"
CLIP_FILE = "stimuli/clip_verb_scores.json"
IMAGE_DIR = "experiments/conceptual-task/chunk_includes"
OUTPUT_DIR = "stimuli/selected_images"
...
def generate_csv_report(rankings, output_file="stimuli/combined_selection_report.csv", experiment_only=False):
